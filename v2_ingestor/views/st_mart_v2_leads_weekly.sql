-- st_mart_v2.leads_weekly
-- Weekly count of leads (unique customers with estimate jobs) company-wide
...
--
-- Grain: One row per week (company-wide aggregate)
--
...
CREATE OR REPLACE VIEW `kpi-auto-471020.st_mart_v2.leads_weekly` AS
